...
from keras.applications import ResNet50 
#include_top=false because we don't want to extract classes, we just want to extract features so we remove the last layer
resnet=ResNet50(include_top=False, weights='imagenet', input_shape=(224,224,3),pooling='avg')

print("*"*50)
print("resnet loaded")
#It should be mine_vocab.npy ******************
...
def after():
    ...
    return render_template('output.html', final=final)
